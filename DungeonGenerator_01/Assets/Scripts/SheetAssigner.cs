...
public class SheetAssigner : MonoBehaviour {
	...
	public Vector3 roomDimensions = new Vector3(0, 16*17,16*9);
	public Vector3 gutterSize = new Vector3(0, 16*9,16*4);
    ...
    public void Assign(Room[,] rooms){
		foreach (Room room in rooms){
			...
			Vector3 pos = new Vector3(room.gridPos.x * (roomDimensions.x + gutterSize.x), room.gridPos.y * (roomDimensions.y + gutterSize.y), 90);
